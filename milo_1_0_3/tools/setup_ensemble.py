...
def main() -> None:
	...
	parser.add_argument(
		...
		help="Amount of time the submission script should request for forward trajectoryies, formatted as HH:MM:SS.",
	)
	parser.add_argument(
		"--time_backward",
		default=None,
	...
	if not args.no_script and args.time == "time_placeholder":
		print("Warning: Time not specified. Replace 'time_placeholder' in submission script before submitting jobs.")
